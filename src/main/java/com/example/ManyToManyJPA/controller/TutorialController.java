...
public class TutorialController {
    ...
    public ResponseEntity<Tutorial> createTutorial(@RequestBody Tutorial tutorial) {
        Tutorial new_tutorial = tutorialRepository
    ...
    public ResponseEntity<Tutorial> updateTutorial(@PathVariable("id") Long id, @RequestBody Tutorial tutorial) {
        Tutorial new_tutorial = tutorialRepository.findById(id)
                .orElseThrow(() -> new ResourceNotFoundException("tutorial not found with id: " + id));
        new_tutorial.setTitle(tutorial.getTitle());
        new_tutorial.setDescription(tutorial.getDescription());
        new_tutorial.setPublished(tutorial.isPublished());

        return new ResponseEntity<>(tutorialRepository.save(new_tutorial), HttpStatus.OK);
    }

    @DeleteMapping("tutorials/{id}")
    public ResponseEntity<HttpStatus> deleteTuorial(@PathVariable("id") Long id) {
